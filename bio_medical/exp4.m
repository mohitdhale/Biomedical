...
fc1 = 100;
fs1 = 300;
[b12,a12] = butter(18,fc1/(fs1/2),'Low');
figure(2)
freqz(b12,a12);
axis tight
...
fc2 = 10;
fs2 = 1000;
[b13,a13] = butter(2,fc2/(fs2/2),'High');
figure(3)
freqz(b13,a13);
axis tight
...
% Derivative filter
b14= designfilt('differentiatorfir', ... % Response type
...
c3=filter(b12,a12,ecg)
figure(1)
subplot(2,3,2)
plot(c3)
axis tight
title('filterolved Signal by Low Pass Filter')


c4=filter(b13,a13,ecg)
figure(1)
subplot(2,3,3)
plot(c4)
axis tight
title('filterolved Signal by High Pass Filter')

c5=conv(ecg,b14.Coefficients)
figure(1)
subplot(2,3,4)
plot(c5)
axis tight
title('filterolved Signal by Derivative Filter')
