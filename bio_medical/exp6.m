% AIM- Noise Removal from ECG Signal using band pass filter of order 3 cutoff= 5-15Hz
...
b11 = designfilt('bandpassfir','FilterOrder',3, ...
         'CutoffFrequency1',5,'CutoffFrequency2',15, ...
         'SampleRate',1500);
fvtool(b11);


c1=conv(n,b11.Coefficients);
figure(1)
subplot(2,3,3)
plot(c1)
axis tight
title('Bandpass Output O=3, Freq=5-15Hz ')
